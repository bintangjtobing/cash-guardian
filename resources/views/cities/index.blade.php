...
@section('addNewData')
    <div class="action-btn">
        <a href="{{ route('cities.create') }}" class="btn btn-sm btn-primary btn-add">
                            ...
                            <table class="table mb-0">
                                <thead>
                                    <tr class="userDatatable-header">
                                        <th>
                                            <div class="userDatatable-title">City Name</div>
                                        </th>
                                        <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                    <li>
                                                        <a href="{{ route('cities.edit', $city->id) }}" class="edit">
                ...
                <nav class="atbd-page">
                    <ul class="atbd-pagination d-flex">
                        <li class="atbd-pagination__item">
                            ...
                            @else
                                <a href="{{ $cities->previousPageUrl() }}" rel="prev" aria-label="Previous">
                                    &laquo; Previous
                                </a>
                            @endif
                        </li>
                        ...
                        <li class="atbd-pagination__item">
                            @if ($cities->hasMorePages())
                                <a href="{{ $cities->nextPageUrl() }}" rel="next" aria-label="Next">
                                    Next &raquo;
                                </a>
                            @else
