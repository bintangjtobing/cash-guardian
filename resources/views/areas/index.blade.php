...
@section('addNewData')
    <div class="action-btn">
        <a href="{{ route('areas.create') }}" class="btn btn-sm btn-primary btn-add">
        ...
        <div class="social-overview-wrap">
                            ...
                            <table class="table mb-0">
                                <thead>
                                    <tr class="userDatatable-header">
                                        <th>
                                            <div class="userDatatable-title">Area Name</div>
                                        </th>
                                        <th>
            ...
            <div class="d-flex justify-content-between mt-30">
                <div class="pagination-info">
                    Showing {{ $areas->firstItem() }} to {{ $areas->lastItem() }} of
                    {{ $areas->total() }} items
                </div>
                ...
                <nav class="atbd-page">
                    <ul class="atbd-pagination d-flex">
                        <li class="atbd-pagination__item">
                            ...
                            @else
                                <a href="{{ $areas->previousPageUrl() }}" rel="prev" aria-label="Previous">
                                    &laquo; Previous
                                </a>
                            @endif
                        </li>
                        ...
                        <li class="atbd-pagination__item">
                            @if ($areas->hasMorePages())
                                <a href="{{ $areas->nextPageUrl() }}" rel="next" aria-label="Next">
                                    Next &raquo;
                                </a>
                            @else
