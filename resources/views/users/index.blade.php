...
@section('addNewData')
    <div class="action-btn">
        <a href="{{ route('users.create') }}" class="btn btn-sm btn-primary btn-add">
                            ...
                            <table class="table mb-0">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <div class="userDatatable-title">Username</div>
                                        </th>
                                        <th>
                                            <div class="userDatatable-title">Email</div>
                                        </th>
                                        <th>
                                            <div class="userDatatable-title">User Group</div>
                                        </th>
                                        <th>
                ...
                <nav class="atbd-page">
                    <ul class="atbd-pagination d-flex">
                        <li class="atbd-pagination__item">
                            ...
                            @else
                                <a href="{{ $users->previousPageUrl() }}" rel="prev" aria-label="Previous">
                                    &laquo; Previous
                                </a>
                            @endif
                        </li>
                        ...
                        <li class="atbd-pagination__item">
                            @if ($users->hasMorePages())
                                <a href="{{ $users->nextPageUrl() }}" rel="next" aria-label="Next">
                                    Next &raquo;
                                </a>
                            @else
